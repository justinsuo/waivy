  ...
  return (
    <div className="mx-auto max-w-3xl">
      <header className="mb-6">
        ...
        <h1 className="mt-1.5 text-3xl font-bold tracking-tight text-stone-900 sm:text-4xl">
          Make Waivy yours.
        </h1>
        ...
        <nav aria-label="Settings sections" className="mt-4 flex flex-wrap gap-2">
          {JUMP_LINKS.map((l) => (
            <a
              key={l.href}
              href={l.href}
              className="rounded-full border border-stone-200 bg-white px-3 py-1.5 text-xs font-medium text-stone-600 transition-colors hover:border-emerald-300 hover:bg-emerald-50 hover:text-emerald-800 focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500"
            >
              {l.label}
            </a>
          ))}
