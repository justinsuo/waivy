...
REGIONS = ["Tex-Mex diner","Southern BBQ joint","New York deli","Chicago","New Orleans","Memphis","Nashville hot","Kansas City","Carolina","Detroit","Philly","Boston","Maine","San Francisco","LA taco","Miami Cuban","Austin food-truck","Portland brunch","Hawaiian plate-lunch","Quebec poutine","Montreal","London pub","Dublin","Edinburgh","Welsh","Cornish","Yorkshire","Lancashire","Glasgow curry","Bristol"]
CATS = ["famous diner classics","famous deli sandwiches","comfort casseroles and bakes","famous regional pizza styles","famous burger styles","loaded mac and cheese variations","famous chili variations","famous wing flavors","famous taco styles","famous burrito and bowl styles","brunch egg dishes","famous breakfast hash styles","famous pancake and waffle styles","famous milkshake and float styles","famous pie and cobbler styles","famous cookie and bar styles","famous quick weeknight skillets","famous one-pot rice dinners","famous ramen and noodle bowls","famous dumpling and bun styles"]
...
json.dump(new, open("/tmp/gen-candidates7.json","w"))
